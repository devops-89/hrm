...
interface DepartmentValuesInterface {
  values: DEPARTMENT_TABLE_DATA;
}

const EditDepartment = ({ values }: DepartmentValuesInterface) => {
  console.log("values", values);
  const dispatch = useDispatch();
  const [status, setStatus] = useState<{ label: string } | null>({
    label: values.status,
  });
